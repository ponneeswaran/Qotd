			...
			<div class="modal-content">
      			...
      			<div class="modal-body">
        			<form role="form">
          				...
          				<div class="form-group">
            				<label for="signUpPsw"><span class="glyphicon glyphicon-eye-open"></span> Password</label>
            				<input type="text" class="form-control" id="signUpPsw" placeholder="Enter password">
          				</div>
          				<div class="form-group">
            				<label for="signUpPsw2"><span class="glyphicon glyphicon-eye-open"></span> Re-enter Password *</label><label for="signUpErrMsg" class="errMsg" id="signUpErrMsg"> </label>
            				<input type="text" class="form-control" id="signUpPsw2" placeholder="Re-Enter password">
          				</div>
